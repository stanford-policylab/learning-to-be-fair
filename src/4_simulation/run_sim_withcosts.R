...
source("act_withcosts.R")
source("inference_withcosts.R")
source("learn_withcosts.R")
source("policy_withcosts.R")
source("population_withcosts.R")

# LP solver setup
Sys.unsetenv("RETICULATE_PYTHON")
library(reticulate)
use_virtualenv("nudge_simulation/", required = TRUE)
...
experiment_size <- 20 #1000
num_sims <- 2 # should be 2000
num_cores <- 10
sim_num_start <- 1000
