Equitable Decision Making and Pareto Frontiers
================
...
Finally, we plot the results, adding points for the utility-maximizing
...
To gain intuition about the equal FNR policy, we plot the FNRs by group
